...
import com.meero.meeromessengerchat.databinding.ActivityChatDetailBinding;
import com.meero.meeromessengerchat.Adapters.ChatAdapter;
...
public class ChatDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.userNameToolbar.setText(userName);
        Picasso.get().load(profilePic).placeholder(R.drawable.userpicture).into(binding.profileImage);
       ...
       binding.settingsIcon.setOnClickListener(new View.OnClickListener() {
        ...
        binding.sendIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                model.setTimespan(new Date().getTime());
